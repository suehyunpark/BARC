...
import tqdm
import json
from gen_dataset_both import Problem, make_input_prompt_induction, convert_chat_format_induction
...
def main():
    ...
    parser.add_argument("--exclude_seeds", action="store_true", help="Exclude seeds")
    ...
    for arc_problem in tqdm.tqdm(problems):
        ...
        uid = arc_problem.uid
        if args.exclude_seeds and uid in seeds_uid:
